...
import {Action, ChannelName, Event} from './core/constants';
...
export default class Client {
  ...
  get connections() { return this.socket.channels; }
  ...
  channel(id) { return this.socket.channel(id); }

  stream(id) { return this.channel(id).stream; }

  on(id, eventName, cb) { return this.channel(id).on(eventName, cb); }

  once(id, eventName) { return this.channel(id).once(eventName); }
  ...
  create(options) { this.channel(API).push(Action.START_CHAIN, {...options}); }
